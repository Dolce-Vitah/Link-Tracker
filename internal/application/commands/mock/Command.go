...
func (_m *Command) Handle(update *tgbotapi.Update, bot command.Sender) error {
...
func (_c *Command_Handle_Call) Run(run func(update *tgbotapi.Update, bot command.Sender)) *Command_Handle_Call {
	_c.Call.Run(func(args mock.Arguments) {
