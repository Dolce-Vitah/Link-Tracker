...
type LinkService interface {
	AddLink(chatID int64, request api.AddLinkRequest) (api.LinkResponse, error)
	RemoveLink(chatID int64, request api.RemoveLinkRequest) (api.LinkResponse, error)
	ListLinks(chatID int64) (api.ListLinksResponse, error)
	ListLinksPage(chatID int64, limit int, offset int) ([]api.LinkResponse, error)
}
